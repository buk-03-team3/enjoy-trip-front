...
export const useTravelStore = defineStore('travelStore', () => {
    ...
    return {sidoList, gugunList, sidoObj, gugunObj, travelList, selectContent, joinContent, searchKeyword,
            contentSelect, getSidoList, getGugunList, searchTravelRegion, searchTravelContent,searchTravelKeyword,
             searchTravel, regionOrContent , }
})
